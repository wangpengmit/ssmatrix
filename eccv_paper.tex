...
% \\&= \sym\bigl((\Id{} - \tW (\kron{\mU}{\Id m}) \pinv{(\tW(\kron{\Id m}\mU))})
% \tW (\kron{\Id m}{\diff[\mU]}) \pinv{(\tW(\kron{\Id m}\mU))} \bigr) \tW \v m
% & \text{from 1}
\eqlabel{jacobian}
\end{align}
...
\begin{align}
\m J \tr \m J &= \begin{multlined}[c][5cm]
\tilde{\m V}^{*\top} \tW \tr \m H \tr \m H \tW \tilde{\m V}^* +
\tilde{\m V}^{*\top} \tW \tr \m H \tr \pinv{(\tW\tU)}\tr \WRT\tr\Ttrans \\
+ \Ttrans \tr \WRT \pinv{(\tW\tU)} \m H \tW \tilde{\m V}^*
+ \Ttrans \tr \WRT \pinv{(\tW\tU)} \pinv{(\tW\tU)} \tr \WRT\tr\Ttrans
\end{multlined} & \comment{Using \eqref{jacobian}}
\\ & = \begin{multlined}[c][5cm]
\tilde{\m V}^{*\top} \tW \tr \m H \tr \m H \tW \tilde{\m V}^*  + \Ttrans \tr \WRT \pinv{(\tW\tU)} \pinv{(\tW\tU)} \tr \WRT\tr\Ttrans
\end{multlined} &
\begin{comment}
Noting\textrm{ }(\tW \tU)^\dagger \m H = \m 0
\end{comment}
\\ & = \begin{multlined}[c][5cm]
\tilde{\m V}^{*\top} \tW \tr \m H \tW \tilde{\m V}^*  + \Ttrans \tr \WRT \left((\tW\tU) \tr (\tW\tU)\right)^{-1} \WRT\tr\Ttrans
\end{multlined} &
\begin{comment}
Noting\textrm{ } \m H^2 = \m H
\end{comment}
\eqlabel{jtj}
\end{align}
